...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy(`${INPUT_BASE_DIR}/js`);
  eleventyConfig.addPassthroughCopy(`${INPUT_BASE_DIR}/img`);
  eleventyConfig.addPassthroughCopy(`${INPUT_BASE_DIR}/css`);
  ...
  eleventyConfig.setBrowserSyncConfig({
    callbacks: {
      ready: function (err, browserSync) {
        const content_404 = fs.readFileSync(`${OUTPUT_PATH}/404/index.html`);
